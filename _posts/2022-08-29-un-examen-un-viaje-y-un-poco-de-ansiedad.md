...
- Uso prolongado de mascarilla: esto podría causar mayor estrés por sí mismo o también podría haber evitado que recurriera a un mecanismo que tenía para lidiar con situaciones estresantes, mi tic nervioso que consiste en arrancarme los pelitos de la barbilla (en [este post]({{ '/blog/por-que-no-me-crece-la-barba/' | relative_url }}) hablo sobre este tic). Practicar más con mascarilla podría servir para minimizar este posible problema, idea que desarrollo en [este otro post]({{ '/blog/semanario-2022-08-29/' | relative_url }}).
