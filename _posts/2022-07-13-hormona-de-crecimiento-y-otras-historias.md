...
Otro tema que considero importante es el de retirarse a tiempo. Creo que muchas veces se idealiza mucho el no rendirse nunca; sin embargo, esto no es absoluto. “Rendirse”, retirarse, renunciar, dejar de hacer algo o como se quiera llamarlo puede ser la decisión correcta en algunas situaciones. En [otro post]({{ '/blog/quien-mucho-abarca-poco-aprieta/' | relative_url }}) se presenta un algoritmo para renunciar, esto puede ser útil para tomar algunas decisiones.
